...
echo.
echo  PURPOSE:
echo    Download and automatically decompress GNSS data files from NASA's CDDIS archive:
...
echo      --date 2025-09-18 --type rinex-v2-gps --out ./ephemeris --verbose
...
echo    * Decompression of .Z files requires the 'uncompress' command-line tool
